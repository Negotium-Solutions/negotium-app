...
export const useAPIBaseStore = defineStore({
    id: 'api-base',
    state: () => ({
        loading: false,
        url: '',
    ...
    actions: {
        init(url, user, tenant, end_point) {
            this.url = url;
            this.user = user;
            this.tenant = tenant;
        ...
        async fetch(id = null, parent_id = null, _with = null)
        {
            ...
            let _url = this.url+'/'+this.user.tenant+'/'+this.end_point;
        ...
        async delete(_item)
        {
            ...
            let _url = this.url+'/'+this.user.tenant+'/'+this.end_point+'/delete/'+_item.id;
