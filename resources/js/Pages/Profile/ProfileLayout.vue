      ...
      <div class="row" id="profiles-sidebar">
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 pl-0 pr-0 profile-info" id="profiles-detail" style="position:relative">
          <div v-show="profileManagerStore.isSelected('profile', profileManagerStore.profile)" class="pt-3 border-right pr-3 pl-3 col-md-12" id="profiles-detail-content">
            ...
            <div><a :href="route('profile.processes', {'id': profileManagerStore.profileId})+'?s_id='+profileManagerStore.schemaId" :class="{' bg-slate-500 text-white' : route().current('profile.processes')}" class="w-100 px-4 py-2 rounded rounded-lg justify-between items-center inline-flex border border-neutral-200 hover:text-gray-700">Processes <i class="fa fa-chevron-right float-right"></i></a></div>
            <div><a :href="route('profile.profile-details', {'id': profileManagerStore.profileId})+'?s_id='+profileManagerStore.schemaId" :class="{' bg-slate-500 text-white' : route().current('profile.profile-details') || route().current('profile.profile-details.edit')}" class="w-100 px-4 py-2 rounded rounded-lg justify-between items-center inline-flex border border-neutral-200 mt-1 hover:text-gray-700">Profile Details <i class="fa fa-chevron-right float-right"></i></a></div>
            <div><a :href="route('profile.communications', {'id': profileManagerStore.profileId})+'?s_id='+profileManagerStore.schemaId" :class="{' bg-slate-500 text-white' : route().current('profile.communications')}" class="w-100 px-4 py-2 rounded rounded-lg justify-between items-center inline-flex border border-neutral-200 mt-1 hover:text-gray-700">Communications <i class="fa fa-chevron-right float-right"></i></a></div>
            <div><a :href="route('profile.documents', {'id': profileManagerStore.profileId})+'?s_id='+profileManagerStore.schemaId" :class="{' bg-slate-500 text-white' : route().current('profile.documents')}" class="w-100 px-4 py-2 rounded rounded-lg justify-between items-center inline-flex border border-neutral-200 mt-1 hover:text-gray-700">Documents <i class="fa fa-chevron-right float-right"></i></a></div>
            <div><a :href="route('profile.notes', {'id': profileManagerStore.profileId})+'?s_id='+profileManagerStore.schemaId" :class="{' bg-slate-500 text-white' : route().current('profile.notes')}" class="w-100 px-4 py-2 rounded rounded-lg justify-between items-center inline-flex border border-neutral-200 mt-1 hover:text-gray-700">Notes & Reminders <i class="fa fa-chevron-right float-right"></i></a></div>
