                ...
                <table class="table table-sm table-borderless p-0 mb-0">
                  <tr>
                    ...
                    <td class="align-right text-right py-0">
                      <a v-if="(profileProcess.process_status_id === 1)" :href="route('process-execution.edit', { process_id: profileProcess.processData.id, process_schema_id: profileProcess.process.id, profile_id: profileManagerStore.profile.id, profile_schema_id: profileManagerStore.schemaId, step_id: profileProcess.step.id})" class="flex justify-center py-2 px-3 text-xs leading-3 rounded-custom-25 border border-solid border-neutral-700 border-opacity-20 text-neutral-700 hover:bg-neutral-700 hover:text-white w-100">
                        Start
                      </a>
                      <a v-else :href="route('process-execution.edit', { process_id: profileProcess.processData.id, process_schema_id: profileProcess.process.id, profile_id: profileManagerStore.profile.id, profile_schema_id: profileManagerStore.schemaId, step_id: profileProcess.step.id})" class="flex justify-center py-2 px-3 text-xs leading-3 rounded-custom-25 border border-solid border-neutral-700 border-opacity-20 text-neutral-700 hover:bg-neutral-700 hover:text-white w-100">
                        Continue
                      </a>
                    </td>
                  </tr>
